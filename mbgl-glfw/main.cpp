...
int main(int argc, char *argv[]) {
    ...
    const std::string cacheDB = cacheDBValue ? args::get(cacheDBValue) : "./mbgl-cache.db";
	...
	*/
    ...
    std::string token("pk.eyJ1IjoibWFtYWNoZmUiLCJhIjoiY2p1dzBndXRjMDdjcDN5cGI2d2duM3d2byJ9.BPbVcece6cQABmqi0CvgZQ");
    if (token.empty()) {
